...
const ImageList=[
    {
      ...
      description:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis ab possimus quae eos eum, molestias a veritatis sapiente non! Ipsum, quibusdam impedit! Quidem illum dolorum cumque corporis quod, adipisci iste?"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2">
                    ...
                    <div className="order-1 sm:order-2">
                        ...
                        data-aos-once="true"
                         ...
                         <img src={data.img} alt=""  className="w-[300px]
                         h-[300px] sm:h-[450px] sm:w-[450px] sm:scale-125
                         lg:scale-120
