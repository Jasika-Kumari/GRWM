...
import BannerImg from '../../assets/hero/women.png'
        ...
        gap-6 items-center">
            ...
            gap-6 sm:pt-0">
               ...
               >
                ...
                tracking-wide leading-5" data-aos="fade-up">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium dolores at odio sequi, possimus veritatis eligendi unde est saepe dolore culpa cumque corrupti magni quae vitae totam blanditiis quasi dignissimos.
                    </p>
                    <div className="flex flex-col gap-4">
                        <div data-aos="fade-up" className="flex items-center gap-4">
                            <GrSecure className="text-4xl h-12 w-12
                            shadow-sm p-4 rounded-full bg-violet-100 dark:bg-voilet-400"/>
